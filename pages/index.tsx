    ...
    <>
      ...
      <HomepageWrapper>
        <WhiteBackgroundContainer>
          ...
          <BasicSection imageUrl="/demo-illustration-2.svg" title="Train your Database" overTitle="STEP 2" reversed>
            <p>
              Your secure Database will be trained on your personal Chatbot which will be able to answer your questions seamlessly in natural language.
            </p>
            <ul>
              <li>Secure Database Connection</li>
              <li>Single Click Training</li>
